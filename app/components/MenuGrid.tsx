...
import { categories, menuNotes } from "@/lib/data/menu";import { categories, menuNotes } from "@/lib/data/menu";

import { currency } from "@/lib/utils";import { currency } from "@/lib/utils";

import { Flame } from "lucide-react";import { Flame } from "lucide-react";



export default function MenuGrid() {export default function MenuGrid() {
    ...
    <div className="space-y-8">    <div className="space-y-8">
      ...
      <div className="grid gap-6 md:grid-cols-2">      <div className="grid gap-6 md:grid-cols-2">
        ...
        {categories.map((cat) => (        {categories.map((cat) => (
          ...
          <section key={cat.id} className="card">          <section key={cat.id} className="card">

            <div className="flex items-center gap-3 mb-5">            <div className="flex items-center gap-3 mb-5">

              <Flame className="text-brand-orange" size={28} />              <Flame className="text-brand-orange" size={28} />

              <h3 className="font-display text-3xl tracking-wide text-brand-cream">{cat.title}</h3>              <h3 className="font-display text-3xl tracking-wide text-brand-cream">{cat.title}</h3>
